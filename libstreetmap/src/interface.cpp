...
//
//    if (!direction_bar.get_direction_mode()) {
//        draw_screen_search_mode();
//    } else {
//        draw_screen_direction_mode();
//    }
...
//    draw_cross_button();
//
//    if (direction_bar.get_display_path()) {
//        draw_path();
//    } else {
//        draw_marker(marked_latlon);
//    }
//
//    if (direction_bar.get_start_point_input().length() == 0) {
...
//    }
//
//    if (direction_bar.get_destination_input().length() == 0) {
//        set_coordinate_system(GL_SCREEN);
//        setcolor(183, 213, 234);
//        setfontsize(12);
...
//            direction_bar.set_start_point_input(mymap.intersection_list[marked_intersection].name);
//            draw_start_point_input();
...
//            direction_bar.set_destination_input(mymap.intersection_list[marked_intersection].name);
//            draw_destination_input();
...
//        direction_bar.set_direction_mode(true);
//        draw_screen();
//    }
//}
//
...
//        draw_first_direction_bar_input_background();
//        if (key_pressed == 8 && !direction_bar.get_start_point_input().empty()) { //if backspace is pressed
//            direction_bar.set_start_point_input(direction_bar.get_start_point_input().pop_back());
//            start_point_input_from_click = false;
//        } else if (key_pressed == 13) { //if enter is pressed, start searching
//            if (direction_bar.get_start_point_input() == direction_bar.get_destination_input()) {
//                same_message();
//            } else{
//                direction_search();
//            }
//        } else if (key_pressed > 31) { // only draw printable char
//            std::string temp_char(1, key_pressed);
//            direction_bar.set_start_point_input(direction_bar.get_start_point_input() + temp_char);
//            start_point_input_from_click = false;
//        }
//
//        draw_start_point_input();
...
//    std::vector<unsigned> dir_path;
//    if (search_poi_flag) {
//        dir_path = handle_search_poi(start_point_id, destination_input);      
//    } else {
//        dir_path = handle_search_inters(start_point_id, end_point_id);  
//    }
//    
//    // draw path
//    direction_bar.set_display_path(true);
//    path_zoom(dir_path);
//    draw_path(); 
//    
...
//        if (curvePoints != 0) {
//            t_point firstCurvePoint = mymap.latlon_to_cartesian(getStreetSegmentCurvePoint(level[current_seg], 0));
//            t_point lastCurvePoint = mymap.latlon_to_cartesian(getStreetSegmentCurvePoint(level[current_seg], curvePoints - 1));
...
//                t_point p1 = mymap.latlon_to_cartesian(getStreetSegmentCurvePoint(level[current_seg], current_curve_point - 1));
//                t_point p2 = mymap.latlon_to_cartesian(getStreetSegmentCurvePoint(level[current_seg], current_curve_point));
//                drawline(p1, p2);
//                if (!direction_path_mode) {
...
//    }
//
//    std::cout << std::endl << std::endl << std::endl << "Direction Instruction" << "<";
//    if (search_poi_flag) {
//        std::cout << "intersection to point of interest" << ">" << std::endl;
//    } else {
//        std::cout << "intersection to intersection" << ">" << std::endl;
//    }
//    std::cout << "Starting at: " << start_point_input << std::endl;
//}
//
//
...
//        LatLon start_ll = mymap.intersection_list[intersection_id_from].position;
//        LatLon end_ll = mymap.intersection_list[intersection_id_to].position;
//        LatLon first_curve_point = getStreetSegmentCurvePoint(cross_street_segment, 0);
//        LatLon last_curve_point = getStreetSegmentCurvePoint(cross_street_segment, mymap.street_segments_list[cross_street_segment].curvePointCount - 1);
...
//            LatLon from = getStreetSegmentCurvePoint(cross_street_segment, i);
//            LatLon to = getStreetSegmentCurvePoint(cross_street_segment, i + 1);
...
//
///*******************************************************************************
// *                   Function Implementation: draw screen elements
// *******************************************************************************/
